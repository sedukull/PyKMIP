...
class TestKmipClient(testtools.TestCase):
    ...
    def test_init(self):
        """
        Test that a KMIPClient can be constructed with valid arguments.
        """
        KmipClient(
            hostname='127.0.0.1',
            port=5696,
    ...
    def test_create_symmetric_key(self):
        ...
        with KmipClient() as client:
            ...
            uid = client.create_symmetric_key(algorithm, length)
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_symmetric_key_on_invalid_algorithm(self):
        """
        ...
        args = ['invalid', 256]
        with KmipClient() as client:
            self.assertRaises(TypeError, client.create_symmetric_key, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_symmetric_key_on_invalid_length(self):
        """
        Test that a TypeError exception is raised when trying to create a
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_symmetric_key_on_closed(self):
        """
        Test that a ClientConnectionNotOpen exception is raised when trying
        ...
        self.assertRaises(
            ClientConnectionNotOpen, client.create_symmetric_key, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_symmetric_key_on_operation_failure(self):
        """
        ...
        self.assertRaisesRegexp(
            KmipOperationFailure, error_msg, client.create_symmetric_key,
            *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_asymmetric_key_pair(self):
        """
        ...
        with KmipClient() as client:
            ...
            public_uid, private_uid = client.create_asymmetric_key_pair(
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_asymmetric_key_pair_on_invalid_algorithm(self):
        """
        ...
        with KmipClient() as client:
            self.assertRaises(
                TypeError, client.create_asymmetric_key_pair, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_asymmetric_key_pair_on_invalid_length(self):
        """
        Test that a TypeError exception is raised when trying to create an
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_asymmetric_key_pair_on_closed(self):
        """
        Test that a ClientConnectionNotOpen exception is raised when trying
        ...
        self.assertRaises(
            ClientConnectionNotOpen, client.create_asymmetric_key_pair, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_create_asymmetric_key_pair_on_operation_failure(self):
        """
        Test that a KmipOperationFailure exception is raised when the
        ...
        self.assertRaisesRegexp(
            ...
            client.create_asymmetric_key_pair, *args)
    ...
    def test_get_secret(self):
        ...
        with KmipClient() as client:
            ...
            result = client.get_secret('aaaaaaaa-1111-2222-3333-ffffffffffff')
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_get_secret_on_invalid_uid(self):
        """
        ...
        args = [0]
        with KmipClient() as client:
            self.assertRaises(TypeError, client.get_secret, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_get_secret_on_closed(self):
        """
        Test that a ClientConnectionNotOpen exception is raised when trying
        ...
        self.assertRaises(ClientConnectionNotOpen, client.get_secret, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_get_secret_on_operation_failure(self):
        """
        Test that a KmipOperationFailure exception is raised when the
        ...
        self.assertRaisesRegexp(
            KmipOperationFailure, error_msg, client.get_secret, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_destroy_secret(self):
        """
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_destroy_secret_on_invalid_uid(self):
        """
        ...
        args = [0]
        with KmipClient() as client:
            self.assertRaises(TypeError, client.destroy_secret, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_destroy_secret_on_closed(self):
        """
        Test that a ClientConnectionNotOpen exception is raised when trying
        ...
        args = ['aaaaaaaa-1111-2222-3333-ffffffffffff']
        self.assertRaises(
            ClientConnectionNotOpen, client.destroy_secret, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_destroy_secret_on_operation_failure(self):
        """
        Test that a KmipOperationFailure exception is raised when the
        ...
        self.assertRaisesRegexp(
            KmipOperationFailure, error_msg, client.destroy_secret, *args)
    ...
    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_register_key_on_invalid_uid(self):
        """
        ...
        args = ['invalid']
        with KmipClient() as client:
            self.assertRaises(TypeError, client.register_key, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_register_key_on_closed(self):
        """
        Test that a ClientConnectionNotOpen exception is raised when trying
        ...
        client = KmipClient()
        args = [key]
        self.assertRaises(ClientConnectionNotOpen, client.register_key, *args)

    @mock.patch('kmip.pie.client.KMIPProxy',
                mock.MagicMock(spec_set=KMIPProxy))
    def test_register_key_on_operation_failure(self):
        """
        Test that a KmipOperationFailure exception is raised when the
        ...
        self.assertRaisesRegexp(
            KmipOperationFailure, error_msg, client.register_key, *args)
